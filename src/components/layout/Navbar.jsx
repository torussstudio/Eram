  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* ── DESKTOP NAV ── */}
        <nav className="absolute left-1/2 -translate-x-1/2 hidden pt-[5px] min-[920px]:flex items-center gap-12 lg:gap-12 xl:gap-16 font-rethink">
          {renderNavItems()}
        </nav>
      ...
      <span className="block h-[2px] w-[19px] bg-black" />
        ...
        >
            ...
            {navItems.map((item) => {
              ...
              return (
                <button
                  ...
                  className="py-4 border-b border-black/[0.08] text-[1.05rem] font-semibold uppercase tracking-[0.05em] text-left text-[#111] hover:text-black transition-colors duration-200"
                >
                  {item.label}
                </button>
              );
          ...
          <div className="px-7 pb-10 mt-auto border-t border-black/10 pt-5">
            <button onClick={()=> navigate("/portal")} className="w-full bg-[#111111] text-white rounded-[10px] py-[14px] font-rethink text-[0.85rem] tracking-[0.04em]">
              Student-Parent Portal
            </button>
          </div>
        </div>
