...
const supportItems = [
  [
    ...
    "MRegular internal assessments across all grades",
  ],
  [
...
export default function AcademicStreams() {
  ...
  return (
    ...
    >
       <div className="w-full max-w-[1300px] mx-auto px-5 sm:px-8 md:px-10 lg:px-16 pt-6 md:pt-10 lg:pt-12 pb-16 md:pb-20 lg:pb-24">
