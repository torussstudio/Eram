...
export default function PhilosophySection() {
  ...
  return (
    <section ref={sectionRef} className="bg-[#ae1431] text-white py-[70px]">
      <div className="max-w-[1100px] mx-auto px-[40px]">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <span
            ref={labelRef}
            className="font-rethink text-[13px] tracking-[0.28em] uppercase text-white/60"
        ...
        {/* CARDS */}
       <div className="mt-16 grid md:grid-cols-4 rounded-[32px] overflow-hidden border border-[#c91c35]">
  {cards.map((item, i) => (
    <div
      key={i}
      ...
      className="
        ...
        min-h-[380px]
        flex flex-col
        border-r border-b border-[#c91c35]
        last:border-r-0
      "
