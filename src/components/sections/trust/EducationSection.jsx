...
const Card = ({
  ...
  return (
    <div className={styles[variant]}>
            {image && (
        <div className="relative w-full h-[220px] overflow-hidden rounded-xl mb-5">
          <img
            src={image}
            alt={title}
...
const PillarHeader = ({ num, label, title, subtitle, active, onClick, headerRef }) => (
  <div className="mt-[20px] mb-[20px]" ref={headerRef}>
    <div className="flex items-start justify-between">
      ...
      <button onClick={onClick} className="mt-[18px] text-[30px] cursor-pointer select-none">
        <span
          style={{
    ...
    <div className="pb-[30px]">
      ...
      <div className="grid md:grid-cols-2 gap-[20px]">
        ...
        <Card
          ...
          image="/images/thanal-school.jpg"
